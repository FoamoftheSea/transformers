...
DILL_CLIP_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "FoamoftheSea/dill-clip-b4": "https://huggingface.co/foamofthesea/dill-clip-b4/blob/main/config.json",
    # See all Dill-CLIP models at https://huggingface.co/models?filter=dill-clip
}


class DillCLIPVisionConfig(PretrainedConfig):
    r"""
    ...
    [SenseTime/deformable-detr](https://huggingface.co/FoamoftheSea/dill-clip-b4) architecture.
    ...
    Args:
        ...
        backbone_config (`PretrainedConfig` or `dict`, *optional*):
            ...
            case it will default to `PvtV2Config()`.
    ...
    ```python
    >>> from transformers import DillCLIPVisionConfig, DillCLIPVisionModel

    >>> # Initializing a DillCLIP FoamoftheSea/dill-clip-b4 style configuration
    >>> configuration = DillCLIPVisionConfig()

    >>> # Initializing a model (with random weights) from the SenseTime/deformable-detr style configuration
    >>> model = DillCLIPVisionModel(configuration)

    >>> # Accessing the model configuration
    >>> configuration = model.config
    ```"""

    model_type = "dill_clip_vision_model"
    attribute_map = {
        "hidden_size": "d_model",
