...
# Copied from transformers.models.deformable_detr.image_processing_deformable_detr
def post_process_object_detection(
    ...
    Args:
        outputs ([`DetrObjectDetectionOutput`, `dict`]):
        ...
        boxes_only (`bool`, *optional*, defaults to False):
            When True, just pass a list or tensor of boxes to be coverted and resized.
    ...
    """
    if not boxes_only:
        if isinstance(outputs, DetrObjectDetectionOutput):
    ...
    if not boxes_only:
        ...
        results = [{"boxes": box} for box in boxes]
...
class MultiformerImageProcessor(BaseImageProcessor):
    r"""
