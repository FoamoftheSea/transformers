...
PANOPTIC_SEGFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "FoamoftheSea/panoptic-segformer-pvtb5": "https://huggingface.co/FoamoftheSea/panoptic-segformer-pvtb5/resolve/main/config.json",
    # See all Panoptic Segformer models at https://huggingface.co/models?filter=panoptic-segformer
}


class PanopticSegformerConfig(PretrainedConfig):
    r"""
