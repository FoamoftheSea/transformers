...
from .configuration_panformer import PanopticSegformerConfig
...
class DeformableDetrMultiscaleDeformableAttention(nn.Module):
    ...
    def __init__(self, config: PanopticSegformerConfig, num_heads: int, n_points: int):
        super().__init__()
...
class DeformableDetrEncoderLayer(nn.Module):
    def __init__(self, config: PanopticSegformerConfig):
        super().__init__()
...
class DeformableDetrPreTrainedModel(PreTrainedModel):
    config_class = PanopticSegformerConfig
...
class DeformableDetrEncoder(DeformableDetrPreTrainedModel):
    ...
    def get_reference_points(spatial_shapes, valid_ratios, device):
        ...
        for level, (height, width) in enumerate(spatial_shapes):
            ...
            # valid_ratios could be useless here. check https://github.com/fundamentalvision/Deformable-DETR/issues/36
